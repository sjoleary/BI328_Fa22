...
`r msmbstyle::question(label = "ques:popmodel-1", text = "List the four fundamental demographic processes that increase and decrease population size.")`
...
`r msmbstyle::question(label = "ques:popmodel-2", text = "Briefly compare and contrast the following characteristics of of population models: closed vs. open population, discrete vs continuous growth, constrained vs unconstrained growth, and density-dependent vs density-independent demographic parameters.")`

`r msmbstyle::question(label = "ques:popmodel-3", text = "Discuss whether it is easier to model a closed or open population and how making (incorrect) assumptions about migration could impact estimates of minimum viable population sizes.")`
...
`r msmbstyle::question(label = "ques:popmodel-4", text = "Briefly discuss whether you think density-independent birth/death rates are a realistic assumption (limitations) along with the benefits of this assumption for population modeling.")`
...
`r msmbstyle::question(label = "ques:popmodel-5", text = "Define what each of these demographic parameter represents and how it changes over time. Keep in mind that adding the line is slightly misleading because it implies that the increase in population size is smooth and continuous; really the population remains unchanged from time t to t+1 and the graph should look more like steps.")`
...
`r msmbstyle::question(label = "ques:popmodel-6", text = "Describe the change in the per capita change in population size over time. Then compare this value to R and explain what this tells you about the population growth model.")`
...
`r msmbstyle::question(label = "ques:popmodel-7", text = "Describe how our demographic parameters change as population size increases and explain this relationship using the geometric growth model.")`
...
`r msmbstyle::question(label = "ques:popmodel-10", text = "One of the most common patterns we see in populations is that birth and death rates may change over time as a result of intraspecific competition - explain what this means.")`
...
`r msmbstyle::question(label = "ques:popmodel-11", text = "Give a brief description of how the population size changes over time under the logistic growth model.")`
...
`r msmbstyle::question(label = "ques:popmodel-12", text = "Give a brief description of how per capita birth and death rates change over time in the context of logistical growth.")`
...
`r msmbstyle::question(label = "ques:popmodel-16", text = "Briefly explain the content and format of the table. Use key descriptions such as age-based, cohort table, etc.")`
...
`r msmbstyle::question(label = "ques:popmodel-17", text = "Give a brief description of the three survivorship types. Use an example to explain what type of characteristics species with each survivorship type would have.")`
...
`r msmbstyle::question(label = "ques:popmodel-18", text = "Give a brief description of each the age-specific survivorship curves for three survivorship types.")`
...
`r msmbstyle::question(label = "ques:popmodel-19", text = "Give a brief description of each the age-specific life expectancies for three survivorship types.")`
...
`r msmbstyle::question(label = "ques:popmodel-20", text = "Argue which survivorship type this species is. Based on the expected life history given the survivorship curve argue whether you expect the population to be increasing, decreasing or stable over time.")`
...
`r msmbstyle::question(label = "ques:popmodel-21", text = "Based on the R0 value is this population increasing, decreasing or stable in size?")`
...
`r msmbstyle::question(label = "ques:popmodel-22", text = "What is your intrinsic growth rate? Is the population increasing, decreasing or stable over time?")`
...
`r msmbstyle::question(label = "ques:popmodel-23", text = "Give a brief definition of a minimum viable population size and explain why it is such an important tool for conservation and management.")`
...
`r msmbstyle::question(label = "ques:popmodel-24", text = "Briefly discuss what a reasonable probability and specified period of time should look like and why formulating these goals is important for management decisions.")`
...
`r msmbstyle::question(label = "ques:popmodel-26", text = "Briefly explain the difference between a stochastic and a deterministic model.")`
...
`r msmbstyle::question(label = "ques:popmodel-27", text = "For a value of lambda = 1, is the population increase, decreasing, or maintaining a stable population size?")`
...
`r msmbstyle::question(label = "ques:popmodel-28", text = "Describe the individual steps involved to use this type of a model to determine the extinction probability of a population.")`
...
`r msmbstyle::question(label = "ques:popmodel-29", text = "Give a brief explanation of the benefit of running a larger number of trials and why it improves the confidence in your results.")`
